...
class ItemList extends React.Component {
  ...
  render() {
    ...
    let { itemList, offer, deliveryCharges } = this.props;
    ...
    let offerDiscount = (totalPrice * ((offer && offer.offerValue) || 0)) / 100;
    return (
      <div>
        {isLoading ? (
          ...
          <div>
            <Button color={isPaid ? "success" : "danger"}>
            ...
            <Table>
              ...
              <TableFooter>
                ...
                >
                  {totalPrice + (deliveryCharges || 0) - offerDiscount}
                </TableCell>
              </TableFooter>
            </Table>
          </div>
